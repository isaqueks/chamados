...
export function montarSystemPrompt(instrucoesTenant?: string | null): string {
  ...
  return [
    ...
    '- O PDF já sai com layout profissional automático (capa com título e data, tabelas',
    '  estilizadas, rodapé paginado) — escreva APENAS o conteúdo em markdown; não descreva',
    '  estilo nem layout.',
