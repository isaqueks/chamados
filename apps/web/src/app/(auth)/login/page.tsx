    ...
    <>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {tenant
              ? `Acesse o suporte de ${tenant.nome_exibicao}.`
        ...
        <CardContent>
          {tenant ? (
            ...
            <Alert variant="destructive">
              <AlertDescription>
                Endereço de tenant desconhecido. Em desenvolvimento, acesse por um
                subdomínio (ex.: <code>acme.localhost:3000</code>) ou use{" "}
