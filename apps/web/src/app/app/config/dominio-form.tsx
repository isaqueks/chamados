    ...
    <form action={acao} className="flex flex-col gap-4">
      ...
      <div className="flex max-w-md flex-col gap-2">
        ...
        <p className="text-xs text-muted-foreground">
          ...
          <code className="font-mono">{slug}.chamados.app</code>. Deixe em branco para remover.
          Aponte um CNAME para a plataforma; TLS/ACME é provisionado no deploy (fora do escopo de
          dev).
        </p>
      </div>
