...
| E-23 | Camada de abstração de provider de IA (uma impl.: Claude Agent SDK, Opus 5)                                                                                                                                                                                                                                     | `01-arquitetura.md`, `05-agente-ia.md`                   |
...
| **M6**  | Fila + worker isolado + abstração de provider de IA (Opus 5)                                                                    | E-16, E-23, E-24                | M5                         |
